...
\cs_new_protected_nopar:Npn \elegant_apply_selected_font:
  {
...
\clist_map_inline:nn { adobe, fandol, founder, mac, macnew, macold, ubuntu, windows, lxgw }
  {
    \elegant_declare_font:nn { ctex-#1 }
      {
        \elegant_if_package_loaded:nTF { ctex }
          ...
          {
            \RequirePackage[UTF8, fontset = #1]{ ctex }
          }
      }
  }
...
\elegant_declare_font:nn { source-han }
  {
    \elegant_if_package_loaded:nF { ctex }
