...
\end{problemset}
\begin{remark}
If you want to customize the title of \lstinline{problemset}, please change the optional argument like in introduction environment. In addition, this environment will be automatically included in the table of contents and header information (Version 4.1).
\end{remark}
...
\datechange{2026/05/01}{release of v4.7.}

\begin{change}
  \item Fix: Fixed wrong header display of appendix chapters under twoside mode (\href{https://github.com/ElegantLaTeX/ElegantBook/issues/256}{issue: \#256}).
  \item Fix: Fixed the bug that the header prematurely displays the next section title when page is full or float uses [p] placement (\href{https://github.com/ElegantLaTeX/ElegantBook/issues/257}{issue: \#257}).
\end{change}
